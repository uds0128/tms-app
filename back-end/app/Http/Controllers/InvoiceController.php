...
class InvoiceController extends Controller
{
    ...
    public function getFromInvoiceNoAndFinancialYear(Request $request, $invoiceNo, $fromDate, $toDate){
        ...
        try{
            ...
            ->select('tbl_challan_msts.challan_mst_id', 'tbl_challan_msts.challan_no','tbl_challan_msts.challan_date', 'tbl_challan_msts.total_qty', 
    ...
    public function addNewInvoiceFromChallan(Request $request){
        ...
        $challan_mst_id = $request->input("challan_mst_id");

        if(tbl_invoice_mst::where('invoice_mst_id', '=', $challan_mst_id)->whereBetween('invoice_date', [$fromDate, $toDate])->where('invoice_mst_status', 1)->exists()){
            $res = array(
                "status" => 0,
        ...
        try{
            ...
            if(tbl_invoice_mst::where('invoice_mst_id', '=', $challan_mst_id)->whereBetween('invoice_date', [$fromDate, $toDate])->first()){
            ...
            $invoice->invoice_mst_id = $challan_mst_id;  

                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr v-for="(data, index) in allData" :key="index">
                                                        ...
                                                        <td v-if="index % 2 ? 0 : 1">
                                                            <button class="btn btn-danger text-md" @click="deleteRow(index)"><font-awesome-icon icon="fa-solid fa-trash-can" /></button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
    ...
    export default {
        ...
        methods: {
            ...
            getFinancialYearOfChallanDate() {
                axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/getfinancialyear/` + this.challanDate).then(response => {
            ...
            addChallan() {
                ...
                axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/getfinancialyear/` + this.challanDate).then(response => {
                    ...
                    if (this.challanNo == '' || this.challanDate == '' || this.selectedCompanyName == '' || this.selectedProductQuality == '' || this.unit == '' || this.totalQty === '' || this.selectedBrokerName == '') {
                        ...
                        axios.post(`${process.env.VUE_APP_BACKEND_URL}/api/challan/insert`, addData)
                            .then((res) => {

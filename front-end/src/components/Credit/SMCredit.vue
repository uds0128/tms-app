...
export default {
  ...
  methods: {
    ...
    getAllCreditDetails: function (page = 1) {
      axios
        .get(
          `${process.env.VUE_APP_BACKEND_URL}/api/credits?page=` +
            page +
            "&paginate=" +
            this.paginate +
            "&search=" +
    ...
    updateDetailsSaveUpdate: function () {
      if (
        ...
        axios
          .put(`${process.env.VUE_APP_BACKEND_URL}/api/credit/update/` + this.creditId, {
    ...
    deleteDetail: function (credit_id) {
      axios
        .delete(`${process.env.VUE_APP_BACKEND_URL}/api/credit/delete/` + credit_id)
        .then((res) => {
          swal
            .fire({
              title: "Success",

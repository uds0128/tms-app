    ...
    export default {
        ...
        methods: {
            ...
            getFromInvoiceNo() {
                ...
                axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/invoice/getfinancialyear/` + this.invoiceNo).then(response => {
                    let i = 0;
            ...
            getFromNumberAndFinancialYear() {
                ...
                axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/invoice/challandata/` + this.invoiceNo + '/' + fromDate + '/' + toDate).then(response => {
                    if (response.data.status == -1) {
                        ...
                        this.challan_mst_id = response.data[1]["challan_mst_id"];

                        axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/getstate/` + this.code).then(response => {
            ...
            getBranchName() {
                ...
                axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/bankbranch/` + this.selectedBank).then(response => {
            ...
            addInvoice() {
                ...
                addData["challan_mst_id"] = this.challan_mst_id;
                ...
                if (this.challan_mst_id == '' || this.invoiceNo == '' || this.invoiceDate == '' || this.dueDate == '' || this.rate == '' || this.selectedBank == '' || this.selectedBank == undefined || this.selectedFinancialYear == '' || this.selectedFinancialYear == undefined) {
                    toastr["error"]("All Fields are Required!");
                } else {
                    axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/verifyinvoicedate/` + this.invoiceDate + '/' + fromDate + '/' + toDate).then(response => {
                        if (response.data.status == 1) {
                            axios.post(`${process.env.VUE_APP_BACKEND_URL}/api/invoice/insert`, addData).then(response => {
                                if (response.data.status == -1) {
                                    var errormsg = response.data.errors;

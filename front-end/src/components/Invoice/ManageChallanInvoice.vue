                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><font-awesome-icon icon="fa-solid fa-minus" /></button>
                                    </div>
                                </div>
                                                ...
                                                <tr v-for="invoice in filters.invoices.data" v-bind:key="
                                                    ...
                                                    <td class="text-center">
                                                        <a :href="'/invoice/pdf/'+invoice.invoice_mst_id"
                                                            target="_blank" class="btn btn-danger btn-sm text-md"><font-awesome-icon icon="fa-solid fa-file-pdf" /></a>
                                                        <button class="btn btn-info btn-sm text-md"
                                                            @click="viewInvoice(invoice.invoice_mst_id    , invoice.challan_no)"><font-awesome-icon icon="fa-solid fa-eye" /></button>
                                                        <button class="btn btn-primary btn-sm text-md"
                                                            @click="editInvoice(invoice.invoice_mst_id)"><font-awesome-icon icon="fa-solid fa-pen" /></button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
    ...
    export default {
        ...
        methods: {
            ...
            getInvoices: function (page = 1) {
                axios
                    .get(
                        `${process.env.VUE_APP_BACKEND_URL}/api/invoices?page=` +
                        page +
                        "&customer=" +
            ...
            viewInvoice: function (invoiceMstId, invoiceNo) {
                axios
                    .get(`${process.env.VUE_APP_BACKEND_URL}/api/invoice/` + invoiceMstId)
                    .then(response => {
            ...
            getBranchName() {
                ...
                axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/bankbranch/` + this.invoiceToEdit.selectedBank).then(response => {
            ...
            getBank() {
                axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/bankinfo`).then(response => {
            ...
            updateInvoice: function () {
                ...
                axios
                    .put(`${process.env.VUE_APP_BACKEND_URL}/api/invoice`, payload)
                    .then(response => {

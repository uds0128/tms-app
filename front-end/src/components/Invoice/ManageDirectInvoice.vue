                                            ...
                                            <tbody class="text-md">
                                                ...
                                                >
                                                    ...
                                                    <td class="text-center">
                                                        <a :href="'/directinvoice/pdf/'+invoice.invoice_mst_id" target="_blank" class="btn btn-danger btn-sm text-md"><font-awesome-icon icon="fa-solid fa-file-pdf" /></a>
                                                        <button class="btn btn-info btn-sm text-md" @click="viewInvoice(invoice.invoice_mst_id, invoice.challan_no)"><font-awesome-icon icon="fa-solid fa-eye" /></button>
                                                        <button class="btn btn-primary btn-sm text-md" @click="editInvoice(invoice.invoice_mst_id)"><font-awesome-icon icon="fa-solid fa-pen" /></button>
                                                        <button class="btn btn-danger btn-sm text-md" @click="confirmInvoiceDeletation(invoice.invoice_mst_id, invoice.challan_no)"><font-awesome-icon icon="fa-solid fa-trash-can" /></button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
...
export default {
    ...
    methods: {
        ...
        loadCustomersForFilter: function(){
            axios
                .get(`${process.env.VUE_APP_BACKEND_URL}/api/customerlist`).then((response) => {
        ...
        loadCategoriesForFilter: function(){
            ...
            axios
            .get(`${process.env.VUE_APP_BACKEND_URL}/api/sellqualitycategories`).then((response) => {
                let allEntry = [{text: "All", value: ""}];
        ...
        loadQualitiesFromCategoryForFilter: function(){
            ...
            axios
                .get(`${process.env.VUE_APP_BACKEND_URL}/api/sellqualityofcategory/` + this.filters.category)
                .then(response => {
                    let allEntry = [{text:"All", value: ""}];
        ...
        loadBrokersForFilter: function(){
            axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/brokerslist`).then((response) => {
                let allEntry = [{text: "All", value: ""}];
        ...
        getInvoices: function (page = 1) {
            axios
                .get(
                    `${process.env.VUE_APP_BACKEND_URL}/api/directinvoices?page=` +
                        page +
                        "&customer=" +
        ...
        viewInvoice: function(invoiceMstId, invoiceNo){
            axios
                .get(`${process.env.VUE_APP_BACKEND_URL}/api/directinvoice/` + invoiceMstId)
                .then(response => {
        ...
        updateInvoice: function(){
            ...
            if(this.isInvoiceDateValid() && this.isInvoiceNoValid() && this.isCustomerValid() && this.isBrokerValid() && this.isCategoryValid() && this.isNoOfUnitsValid() && this.isQualityValid() && this.isQtyValid() && this.isUnitValid() && this.isRateValid() && this.isGSTPercentageValid()){
                ...
                axios
                    .put(`${process.env.VUE_APP_BACKEND_URL}/api/directinvoice`, invoice)
                    .then(response => {
        ...
        loadQualitiesOfSelectedCategory: function(){
            ...
            axios
                .get(`${process.env.VUE_APP_BACKEND_URL}/api/sellqualityofcategory/` + this.invoiceToEdit.category)
                .then(response => {
        ...
        deleteInvoice: function(invoiceMstId){
            axios
                .delete(`${process.env.VUE_APP_BACKEND_URL}/api/directinvoice/`+ invoiceMstId)
                .then(res => {

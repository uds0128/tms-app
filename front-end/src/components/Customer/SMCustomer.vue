...
export default {
  ...
  methods: {
    getAllCustomers: function (page = 1) {
      axios
        .get(
          `${process.env.VUE_APP_BACKEND_URL}/api/customers?page=` +
            page +
            "&paginate=" +
            this.paginate +
            "&search=" +
    ...
    UpdateCustomer: function () {
      if (
        ...
        axios
          .put(`${process.env.VUE_APP_BACKEND_URL}/api/customer/update/` + this.customerId, {
    ...
    deleteCustomer: function (customer_id) {
      axios
        .delete(`${process.env.VUE_APP_BACKEND_URL}/api/customer/delete/` + customer_id)
        .then((res) => {
          swal
            .fire({
              title: "Success",

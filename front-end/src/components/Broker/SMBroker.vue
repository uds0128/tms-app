                ...
                <div v-if="brokerId == -1 ? 0 : 1" class="card card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <button type="button" class="btn btn-tool" @click="closeEditBroker">
    ...
    export default {
        ...
        methods: {
            getAllBrokers: function (page = 1) {
                axios
                    .get(
                        `${process.env.VUE_APP_BACKEND_URL}/api/brokers?page=` +
                        page +
                        "&paginate=" +
                        this.paginate +
                        "&search=" +
            ...
            updateBroker: function () {
                if ((this.editBrokerName == '' || this.editContactNo == '')) {
                    ...
                    axios
                        .put(`${process.env.VUE_APP_BACKEND_URL}/api/broker/update/` + this.brokerId, {
            ...
            deleteBroker: function (broker_id) {
                axios
                    .delete(`${process.env.VUE_APP_BACKEND_URL}/api/broker/delete/` + broker_id)
                    .then((res) => {
                        swal.fire({
                            title: "Success",
                            html:

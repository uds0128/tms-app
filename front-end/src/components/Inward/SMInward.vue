    ...
    methods: {
     ...
     // Method for loading product qualities in filter
      loadQualitiesOfCategoryForFilter: function () {
        ...
        axios
          .get(`${process.env.VUE_APP_BACKEND_URL}/api/inwardqualityofcategories/` + this.selectedCategoryForFilter)
          .then((response) => {
            let allEntry = [{ text: "All", value: "" }];
      ...
      getInwards: function (page = 1) {
        axios
          .get(
            `${process.env.VUE_APP_BACKEND_URL}/api/inwards?page=` +
            page +
            "&paginate=" +
            this.paginate +
            "&company=" +
      ...
      editGetFromSelectedCompany: function () {
        ...
        axios
          .get(`${process.env.VUE_APP_BACKEND_URL}/api/selectedvendordata/` + this.editSelectedCompanyName)
          .then((response) => {
      ...
      loadFromSelectedCategory: function () {
        ...
        axios
          .get(`${process.env.VUE_APP_BACKEND_URL}/api/inwardqualityofcategories/` + this.editSelectedProductQualityCategory)
          .then((response) => {
      ...
      editInward: async function (inwardMstId) {
        axios
          .get(`${process.env.VUE_APP_BACKEND_URL}/api/inward/view/` + inwardMstId)
          .then((response) => {
      ...
      updateInward: function () {
        if (
          ...
          //return;
          axios
          .put(`${process.env.VUE_APP_BACKEND_URL}/api/inward/update/` + this.inwardIdToBeEdit, payload)
          .then((res) => {
            console.log(res);
      ...
      deleteInward(inwardMstId) {
        axios
          .delete(`${process.env.VUE_APP_BACKEND_URL}/api/inward/delete/` + inwardMstId)
          .then((res) => {
      ...
      */
      ...
      loadQualityCategories() {
        axios
          .get(`${process.env.VUE_APP_BACKEND_URL}/api/inwardqualitycategories`)
          .then((response) => {

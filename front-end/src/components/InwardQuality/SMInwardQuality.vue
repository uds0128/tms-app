  ...
  export default {
    ...
    methods: {
      getAllInwardQualities: function (page = 1) {
        axios
          .get(
            `${process.env.VUE_APP_BACKEND_URL}/api/inwardqualities?page=` +
            page +
            "&paginate=" +
            this.paginate +
            "&search=" +
      ...
      updateInwardQuality: function () {
        if ((this.selectedQualityCategory == '') || (this.editQualityName == '')) {
          ...
          axios
            .put(`${process.env.VUE_APP_BACKEND_URL}/api/inwardquality/update/` + this.inwardQualityId, {
      ...
      deleteInwardQuality: function (inward_quality_id) {
        axios
          .delete(`${process.env.VUE_APP_BACKEND_URL}/api/inwardquality/delete/` + inward_quality_id)
          .then((res) => {
            swal.fire({
              title: "Success",
              html:

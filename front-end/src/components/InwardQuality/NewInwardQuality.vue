  ...
  <div>
    ...
    <div class="row">
      ...
      <div class="col-md-12 mt-3">
        ...
        <!-- New Inward Quality Form Elements -->
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">New Inward Quality</h3>
          ...
          <div class="card-footer">
            <button type="submit" v-on:click="addInwardQuality" class="btn btn-primary text-md">Add</button>
  ...
  export default {
    ...
    methods: {
      ...
      loadQualityCategories() {
        axios.get(`${process.env.VUE_APP_BACKEND_URL}/api/inwardqualitycategories`).then((response) => {
      ...
      addInwardQuality() {
        ...
        if ((this.selectedQualityCategory == '') || (this.qualityName == '')) {
          ...
          axios
            .post(`${process.env.VUE_APP_BACKEND_URL}/api/inwardquality/insert`, addData)
            .then((res) => {
              if (res.data.status == -1) {
                ...
                swal.fire({
                  title: 'Success',
                  html: "<h5 style='color:#9C9794'>Inward Quality Data Added Successfully!</h5>",
                  icon: 'success'
                }).then((result) => {
                  this.resetFields();
                  this.$emit("refreshInwardQualityTable");
                });
              }
            }).catch((err) => {

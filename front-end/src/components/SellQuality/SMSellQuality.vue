  ...
  export default {
    ...
    methods: {
      getAllSellQualities: function (page = 1) {
        axios
          .get(
            `${process.env.VUE_APP_BACKEND_URL}/api/sellqualities?page=` +
            page +
            "&paginate=" +
            this.paginate +
            "&search=" +
      ...
      updateSellQuality: function () {
        if ((this.selectedQualityCategory == '') || (this.editQualityName == '')) {
          ...
          axios
            .put(`${process.env.VUE_APP_BACKEND_URL}/api/sellquality/update/` + this.sellQualityId, {
      ...
      deleteSellQuality: function (sell_quality_id) {
        axios
          .delete(`${process.env.VUE_APP_BACKEND_URL}/api/sellquality/delete/` + sell_quality_id)
          .then((res) => {
            swal.fire({
              title: "Success",
              html:

            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-tool" data-card-widget="collapse"><font-awesome-icon icon="fa-solid fa-minus" />
                        </button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                ...
                >
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-tool" @click="closeUpdateExpenseCategoryBtn" ><font-awesome-icon icon="fa-solid fa-xmark" />
                        </button>
                        </div>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    methods: {
        getAllExpenseCategories: function(page = 1) {
            axios
                .get(
                    `${process.env.VUE_APP_BACKEND_URL}/api/expensecategories?page=` +
                        page +
                        "&paginate=" +
                        this.paginate +
                        "&search=" +
        ...
        updateCategorySaveUpdate: function() {
            if (this.expenseCategoryTxt == "") {
                ...
                axios
                    .put(
                        `${process.env.VUE_APP_BACKEND_URL}/api/expensecategory/update/` + this.expenseCategoryId,
                        {
        ...
        deleteCategory: function(expense_category_id) {
            axios
                .delete(`${process.env.VUE_APP_BACKEND_URL}/api/expensecategory/`+ expense_category_id)
                .then(res => {
                    if(res.data.status == 1){
                        swal.fire({
                                title: "Success",

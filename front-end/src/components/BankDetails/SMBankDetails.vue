    ...
    export default {
        ...
        methods: {
            getAllBankDetails: function (page = 1) {
                axios
                    .get(
                        `${process.env.VUE_APP_BACKEND_URL}/api/bankdetails?page=` +
                        page +
                        "&paginate=" +
                        this.paginate +
                        "&search=" +
            ...
            updateBankDetailsSaveUpdate: function () {
                if (this.bankName == "" || this.branchName == "" || this.ifscCode == "" || this.accNo == "") {
                    ...
                    axios
                        .put(`${process.env.VUE_APP_BACKEND_URL}/api/bankdetail/update/` + this.bankDetailId, {
            ...
            deleteBankDetail: function (bank_detail_id) {
                axios
                    .delete(`${process.env.VUE_APP_BACKEND_URL}/api/bankdetail/delete/` + this.bank_details_id)
                    .then((res) => { })
                    .catch({});
            },
            ...
            deleteBankDetail: function (bank_details_id) {
                axios
                    .delete(`${process.env.VUE_APP_BACKEND_URL}/api/bankdetail/delete/` + bank_details_id)
                    .then((res) => {
                        swal
                            .fire({
                                title: "Success",
